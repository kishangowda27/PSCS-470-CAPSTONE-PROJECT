...
const Dashboard = () => {
  ...
  const stats = [
    ...
    { icon: Calendar, label: 'Events Attended', value: '8', change: '+2 this month', color: 'text-purple-600 dark:text-purple-400' },
    { icon: MessageCircle, label: 'AI Sessions', value: '24', change: '+5 this week', color: 'text-orange-600 dark:text-orange-400' },
  ];

  const quickActions = [
    { icon: Target, title: 'Skill Assessment', description: 'Take a quick skill assessment', link: '/skills', color: 'bg-blue-500' },
    { icon: MessageCircle, title: 'Ask AI Advisor', description: 'Get personalized career advice', link: '/chat', color: 'bg-green-500' },
    { icon: Calendar, title: 'Browse Events', description: 'Find networking opportunities', link: '/events', color: 'bg-purple-500' },
    { icon: Users, title: 'Find Mentors', description: 'Connect with industry experts', link: '/events', color: 'bg-orange-500' },
  ];
    ...
    <div className="space-y-6">
        ...
        <Card className="p-6">
          ...
          <div className="space-y-4">
            <div className="flex items-start space-x-3">
              ...
              <div>
                <p className="text-sm font-medium text-gray-900 dark:text-white">Completed "Python Fundamentals" course</p>
            ...
            <div className="flex items-start space-x-3">
              ...
              <div>
                <p className="text-sm font-medium text-gray-900 dark:text-white">Attended "AI Career Fair 2025"</p>
            ...
            <div className="flex items-start space-x-3">
              ...
              <div>
                <p className="text-sm font-medium text-gray-900 dark:text-white">Started mentorship with Sarah Chen</p>
            ...
            <div className="flex items-start space-x-3">
              ...
              <div>
                <p className="text-sm font-medium text-gray-900 dark:text-white">Updated career goal to "Data Scientist"</p>
      ...
      <Card className="p-6">
        <div className="flex items-center justify-between mb-4">
          <h2 className="text-lg font-semibold text-gray-900 dark:text-white">Your Career Journey Progress</h2>
          <Award className="h-5 w-5 text-primary-600 dark:text-primary-400" />
        </div>
        <div className="space-y-4">
          <div>
            <div className="flex justify-between text-sm">
              <span className="font-medium text-gray-700 dark:text-gray-300">Data Science Skills</span>
          ...
          <div>
            <div className="flex justify-between text-sm">
              <span className="font-medium text-gray-700 dark:text-gray-300">Networking & Experience</span>
          ...
          <div>
            <div className="flex justify-between text-sm">
              <span className="font-medium text-gray-700 dark:text-gray-300">Portfolio & Projects</span>
